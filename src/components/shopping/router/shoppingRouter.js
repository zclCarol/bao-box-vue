...
export const shoppingRouter = [
  ...
  {
    path: '/realShoppingHome',
    name: 'realShoppingHome',
    component: () => import('../RealShoppingHome.vue')
  },
  {
    path: '/shoppingHome',
    name: 'shoppingHome',
    component: () => import('../ShoppingHome.vue')
  },
  {
    path: '/error',
    name: 'Error',
  ...
  //   path: '/collect',
  //   name: 'Collect',
  //   component: () => import('../components/shopping//Collect.vue'),
  //   meta: {
  //     requireAuth: true // 需要验证登录状态
  //   }
  // },
  ...
  },
  {
    path: '/confirmOrder',
    name: 'ConfirmOrder',
    component: () => import('../ConfirmOrder.vue'),
    meta: {
      requireAuth: true // 需要验证登录状态
    }
  }
